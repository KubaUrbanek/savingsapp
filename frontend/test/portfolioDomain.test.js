...
import { AllocationWeight, InvestmentClassificationPolicy, InvestmentEntry, Money, ValuationDate } from '../src/domain/portfolio/index.js';
...
test('entry factory creates immutable valid domain state with canonical null subcategory', () => {
  const entry = InvestmentEntry.create({ id: '1', type: 'KONTO_BANKOWE', owner: 'JAN', subcategory: undefined,
    valuePln: '10.00', date: '2026-09-01', createdAt: '2026-09-01T10:00:00Z', updatedAt: '2026-09-01T10:00:00Z' });
