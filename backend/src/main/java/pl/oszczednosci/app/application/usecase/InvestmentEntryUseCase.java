...
public final class InvestmentEntryUseCase implements CreateInvestmentEntryUseCase, UpdateInvestmentEntryUseCase,
 ...
 public List<InvestmentEntry> list(InvestmentFilter f) { if(f.type()!=null&&f.subcategory()!=null) AssetCategory.of(f.type(),f.subcategory()); return repository.matching(InvestmentEntryCriteria.matching(f.owner(),f.type(),f.subcategory())); }
