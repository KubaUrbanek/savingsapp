...
public final class InvestmentEntry {
    ...
    private InvestmentEntry(InvestmentEntryId id, AssetCategory category, OwnerId owner, Money value,
    ...
    public static InvestmentEntry create(InvestmentEntryId id, AssetCategory category, OwnerId owner,
            Money value, LocalDate date, Instant createdAt) {
        return new InvestmentEntry(id, category, owner, value, date, createdAt, null);
    }

    public static InvestmentEntry reconstitute(InvestmentEntryId id, AssetCategory category, OwnerId owner,
    ...
    public InvestmentEntry update(AssetCategory category, OwnerId owner, Money value, LocalDate date, Instant updatedAt) {
