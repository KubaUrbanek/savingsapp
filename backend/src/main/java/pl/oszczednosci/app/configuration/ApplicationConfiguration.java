...
public class ApplicationConfiguration {
 ...
 @Bean InvestmentEntryUseCase investmentEntryUseCase(JsonInvestmentEntryRepository repository, JsonInvestmentStore store, Clock clock, IdGenerator ids){ return new InvestmentEntryUseCase(repository,store,clock,ids); }
